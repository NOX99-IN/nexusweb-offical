        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <a
                id="contact-page-whatsapp-founder"
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-cyan-500/20 text-[#67e8f9] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform border border-cyan-500/30">
                  <MessageCircle className="w-6 h-6 fill-[#67e8f9]/20" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between">
                    <span className="block text-xs font-medium text-cyan-200/80">
                      WhatsApp (Team Member Support)
                    </span>
                    <span className="text-[10px] font-bold text-[#67e8f9] bg-cyan-500/15 px-2 py-0.5 rounded-full border border-cyan-500/30">
                      Team Support
                    </span>
                  </div>
                  <span className="font-bold text-white text-base truncate block mt-0.5">
                  ...
                  <span className="block text-xs text-[#67e8f9]">
                    Quick client queries &amp; project assistance
                  </span>
                </div>
              </a>
