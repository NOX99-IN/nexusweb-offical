...
export const Portfolio: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="w-full bg-[#0b1326] py-16 lg:py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 4 Case Studies Grid with 3D Tilt */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8" style={{ perspective: 1200 }}>
          {PORTFOLIO_CASES.map((item, index) => {
            const caseGradients = [
              'bg-gradient-to-br from-[#1e1b4b]/90 via-[#0f172a]/95 to-[#172554]/80 border-blue-500/40 hover:border-blue-400/80 shadow-[0_16px_40px_rgba(37,99,235,0.18)]',
              'bg-gradient-to-br from-[#701a75]/90 via-[#0f172a]/95 to-[#831843]/80 border-pink-500/40 hover:border-pink-400/80 shadow-[0_16px_40px_rgba(236,72,153,0.18)]',
              'bg-gradient-to-br from-[#0c4a6e]/90 via-[#0f172a]/95 to-[#155e75]/80 border-cyan-500/40 hover:border-cyan-400/80 shadow-[0_16px_40px_rgba(6,182,212,0.18)]',
              'bg-gradient-to-br from-[#064e3b]/90 via-[#0f172a]/95 to-[#065f46]/80 border-emerald-500/40 hover:border-emerald-400/80 shadow-[0_16px_40px_rgba(0,165,114,0.18)]',
            ];
            ...
            return (
              <motion.div
                ...
                className="h-full"
              >
                <ThreeDTilt maxTilt={8} scale={1.02} className="h-full rounded-3xl">
                  <div
                    className={`rounded-3xl ${gradient} border overflow-hidden shadow-xl flex flex-col justify-between group transition-all duration-300 h-full`}
                  ...
                  >
                    ...
                    {/* Card Content */}
                    <div className="p-7 flex-1 flex flex-col justify-between" style={{ transform: 'translateZ(20px)' }}>
                      <div>
                      ...
                      <div className="pt-2 flex items-center justify-between">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 text-sm font-bold text-[#93c5fd] hover:text-white transition-colors group-hover:underline cursor-pointer"
                        >
        ...
        <motion.div
          ...
          className="mt-16 p-6 rounded-2xl bg-gradient-to-r from-indigo-950/85 via-slate-900/95 to-emerald-950/85 border border-indigo-500/40 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#222a3d] hover:bg-[#2d3449] text-white text-xs font-bold border border-[#2d3449] transition-colors shrink-0 shadow-sm"
          >
