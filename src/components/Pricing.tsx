...
export const Pricing: React.FC = () => {
  ...
  return (
    <section id="pricing-section" className="w-full bg-[#131b2e] py-16 lg:py-24 border-t border-[#222a3d]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2-Tier Pricing Comparison Cards */}
            ...
            return (
              <div
                ...
                className={`relative flex flex-col justify-between p-7 sm:p-9 rounded-3xl transition-all duration-300 ${
                  isPopular
                    ? 'bg-gradient-to-br from-[#064e3b]/90 via-[#0f172a]/95 to-[#065f46]/80 border-2 border-[#00a572] shadow-[0_20px_50px_rgba(0,165,114,0.25)] lg:-translate-y-2'
                    : 'bg-gradient-to-br from-[#1e1b4b]/90 via-[#0f172a]/95 to-[#172554]/80 border border-blue-500/40 shadow-[0_16px_40px_rgba(37,99,235,0.15)]'
                }`}
              >
                {/* Popular Pill */}
                {isPopular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-[#00a572] to-[#10b981] text-white text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-1.5 whitespace-nowrap border border-white/20">
